export default {
    ...
    landing: {
        ...
        pricing: {
            title: "Buy ad slot",
            subtitle: "Our visitors come from leading tech companies, innovative startups, and development agencies worldwide, all united by their interest in AI-enhanced development tools and workflow optimization.",
            includes: "What this plan includes:",
            basic: "Basic",
            premium: "Premium",
            perMonth: "/ month",
            basicfeatures: {
                solution: "Reach a Highly Engaged Audience",
                stripe: "Massive Exposure",
                auth: "Premium Placement",
                authorization: "Targeted Professional Audience",
                dashboard: "Real-Time Campaign Analytics",
            },
            premiumfeatures: {
                solution: "Reach a Highly Engaged Audience",
                stripe: "Massive Exposure",
                ...
                authorization: "Targeted Professional Audience",
                dashboard: "Real-Time Campaign Analytics",
                support: "Priority Access to Community Updates",
            },
            supportTitle: "How will your support help the community?",
            supportDescription: "Every contribution will be used for the continuous optimization of [The Group Finder] platform, creator incentives, support for quality content, and the organization of community activities, jointly creating a prosperous and healthy AIGC creation ecosystem."
        },
    },
    footer: {
        company: "Company",
    ...
    group: {
        ...
        members: {
            ...
            invite: {
                ...
                processingTitle: "Processing Invite",
                loginPrompt: "Someone sent you an invite, but you need to first login to accept it. Click the button below to get started.",
                loginButton: "Login to Accept Invite",
                errors: {
                    notFoundOrExpired: "This invite does not exist or has expired",
                    expired: "This invite has expired",
                },
                emailSubject: "You have been invited to join a group on {appName}",
            },
            memberActions: {
                kickTitle: "Kick Member",
                kickDescription: "Are you sure you want to kick this member from the group?",
                kickConfirm: "Yes, Kick Them",
